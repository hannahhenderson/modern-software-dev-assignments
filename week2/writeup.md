...
To verify your refactored code:
```
# Activate virtual environment
source venv/bin/activate

# Linting and formatting
ruff check app/services/ && ruff format app/services/

# Type checking
mypy app/services/

# Testing (heuristic method - most reliable)
python -m pytest tests/test_extract.py::test_heuristic_extraction -v

# Test the refactored functionality
python -c "
from app.services.extract import extract_action_items_unified
text = 'todo: Test the refactored code'
...
Prompt: 
```
<apparently, I've been using agent mode this whole time>

update the code so that it uses the heuristic extractor functionality by default

tell me where the "extract" button is located in the UI
